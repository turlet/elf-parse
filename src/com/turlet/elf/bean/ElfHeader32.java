...
public class ElfHeader32 {
    ...
    public static ElfHeader32 parse(Magic magic, Elf32.Elf32_Ehdr ehdr){

        ElfHeader32 header = new ElfHeader32();
        header.magic = magic;
        ...
        header.e_entry = Utils.byte4ToLong(ehdr.e_entry);
        header.e_phoff = Utils.byte4ToLong(ehdr.e_phoff);
        header.e_shoff = Utils.byte4ToLong(ehdr.e_shoff);
