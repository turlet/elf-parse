 ...
 */
public class ElfSectionDynsym64 {
    ...
    public static ElfSectionDynsym64 parse(Elf64.Elf64_Sym sym) {

        ElfSectionDynsym64 header = new ElfSectionDynsym64();
        ...
        header.st_value = Utils.byte8ToLong(sym.st_value);
        header.st_size = Utils.byte8ToLong(sym.st_size);
    ...
    public void print(){
        Log.i("   "+ Utils.formatValue(String.valueOf(index), 3," ",false)+": "+
                Utils.formatValue(Long.toHexString(st_value), 16,"0",false)+"  "+
